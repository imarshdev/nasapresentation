      ...
      <FadeInView delay={".5s"}>
        <div style={{ marginBottom: "20px" }}>
          ...
          <p style={{ fontSize: "14px", lineHeight: "1.6", color: "#666" }}>
            ...
            than just visiting places; it's about creating lasting memories. We
            are committed to providing exceptional service and ensuring that
      ...
      <FadeInView delay={"1s"}>
        <div style={{ marginBottom: "20px" }}>
          ...
          <ul style={{ fontSize: "14px", lineHeight: "1.8", color: "#666" }}>
            ...
            <p>
              Gorilla Trekking: Experience the once-in-a-lifetime opportunity to
            ...
            <p>
              Global Visa Assistance: Guidance for visa applications worldwide.
            </p>
          </ul>
        </div>{" "}
      </FadeInView>
      ...
      <FadeInView delay={"1.5s"}>
        <div style={{ marginBottom: "20px" }}>
          ...
          <p style={{ fontSize: "14px", lineHeight: "1.6", color: "#666" }}>
            ...
            experiences and enriching the lives of our clients by exploring the
            beauty of Uganda and beyond.
          </p>
        </div>
      </FadeInView>
